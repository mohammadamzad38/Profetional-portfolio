            ...
            <section className="ml-0 md:ml-12">
                <header className="text-center lg:text-left">
                    <h1 className="pt-4 text-white font-bold text-4xl md:text-5xl lg:text-6xl">
                        Hi I'm <span className="text-transparent bg-clip-text g-gradient-to-br from-[#FFC107] to-[#ff18b8] ">Amzad</span>
                    </h1>
                </header>
                <p className="text-gray-300 pt-8 text-center lg:text-left mx-auto max-w-[370px] md:mx-w-xl">Lorem ipsum dolor sit amet consectetur adipisicing elit. Adipisci, voluptates non? Ex dignissimos rerum ab? Esse nulla incidunt hic quas omnis excepturi, natus ex veritatis inventore officia assumenda quo ipsam.</p>
                <section className="flex items-center gap-3 pt-9 flex-col sm:flex-row sm:w-max sm:mx-auto lg:mx-0">
                    <figure className="w-56">
                        <button>Hire me</button>
                    </figure>
                    <motion.button whileHover={{scale:1.1}} className="flex items-center px-4 py-2 bg-transparent text-[#FFC107] border border-[#FFC107] rounded-3xl">
